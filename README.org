...
**** ~rh/act-inside~ and ~rh/change-inside-forward~
...
(this is a "nice| string" inside a parenthesis)
#+END_SRC

Pressing ~M-i~ takes us to

#+BEGIN_SRC emacs-lisp
(this is a "|" inside a parenthesis)
#+END_SRC
...
+ The command ~rh/change-inside-forward~ (bound to ~M-I~) does the same but for the next balanced expression. Suppose we have

#+BEGIN_SRC emacs-lisp
(the fruits |are "apple" and "mango")
#+END_SRC

Then pressing ~M-I~ takes us to

#+BEGIN_SRC emacs-lisp
(the fruits are "|" and "mango")
#+END_SRC

Then typing a fruit (say, banana) and then pressing ~M-I~ takes us to

#+BEGIN_SRC emacs-lisp
(the fruits are "banana" and "|")
#+END_SRC

+ The command ~rh/change-inside-forward~ also accepts universal argument. Here, ~C-u M-I~ does the same thing in the backward direction. Suppose we have

#+BEGIN_SRC emacs-lisp
(the fruits are "apple" and "man|go")
#+END_SRC

Then pressing ~C-u M-I~ takes us to
